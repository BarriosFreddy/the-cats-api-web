...
import { BreedImage } from '../../../../src/domain/entities/Breed';
...
describe('GetBreedImagesUseCase', () => {
  let getBreedImagesUseCase: GetBreedImagesUseCase;
  ...
  beforeEach(() => {
    getBreedImagesUseCase = new GetBreedImagesUseCase(mockBreedRepository);
    jest.clearAllMocks();
  });
